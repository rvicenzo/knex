...
angular.module('starter', ['ionic', 'starter.menuTeste', 'starter.explore', 'starter.menu', 'starter.curso', 'starter.subcategorias', 'starter.texto', 'starter.contato', 'starter.chat'])
...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  .state('app.texto', {
    ...
    views: {
      'menuContent': {
        templateUrl: 'apps/texto/texto.html'
      }
    }
  })
  .state('app.contato', {
    ...
    views: {
      'menuContent': {
        templateUrl: 'apps/contato/contato.html'
      }
    }
  })
  .state('app.chat', {
